...
public class JDlgConsultaUsuarios extends javax.swing.JDialog {
    ...
    private void jBtnConsultaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConsultaActionPerformed
        // TODO add your handling code here:
        if(jTxtApelido.getText().isEmpty() == false && jTxtNome.getText().isEmpty() == false){
           List lista = (List) usuariosDAO.listNomeApelido(jTxtNome.getText(), jTxtApelido.getText() );
        controllerConsultasUsuarios.setList(lista);
        }
        ...
        List lista = (List) usuariosDAO.listNome(jTxtApelido.getText());
        controllerConsultasUsuarios.setList(lista);
